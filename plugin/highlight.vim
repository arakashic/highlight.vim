...
noremap  <silent> <C-s><C-h> :call <SID>Highlight("h") \| nohls<CR>
" Advance color for next line highlight
noremap  <silent> <C-s><C-a> :call <SID>Highlight("a")<CR>
" Clear last line highlight
noremap  <silent> <C-s><C-r> :call <SID>Highlight("r")<CR>

" Highlight word under cursor (whole word match)
noremap  <silent> <C-s><C-w> :call <SID>Highlight("w") \| nohls<CR>
" Highlight all lines having word under cursor (whole word match)
noremap  <silent> <C-s><C-l> :call <SID>Highlight("l") \| nohls<CR>
" Highlight word under cursor (partial word match)
noremap  <silent> <C-s><C-f> :call <SID>Highlight("f") \| nohls<CR>
" Highlight all lines having word under cursor (partial word match)
noremap  <silent> <C-s><C-k> :call <SID>Highlight("k") \| nohls<CR>
" Highlight last search pattern
noremap  <silent> <C-s><C-s> :call <SID>Highlight("s") \| nohls<CR>
" Highlight all lines having last search pattern
noremap  <silent> <C-s><C-j> :call <SID>Highlight("j") \| nohls<CR>
" Clear last pattern highlight
noremap  <silent> <C-s><C-d> :call <SID>Highlight("d")<CR>

" Clear all highlights
noremap  <silent> <C-s><C-n> :call <SID>Highlight("n")<CR>


" -- Insert mode mappings --

" Highlight current line 
inoremap <silent> <C-s><C-h> <C-o>:call <SID>Highlight("h")<CR>
" Advance color for next line highlight
inoremap <silent> <C-s><C-a> <C-o>:call <SID>Highlight("a")<CR>
" Clear last line highlight
inoremap <silent> <C-s><C-r> <C-o>:call <SID>Highlight("r")<CR>

" Highlight word under cursor (whole word match)
inoremap <silent> <C-s><C-w> <C-o>:call <SID>Highlight("w") \| nohls<CR>
" Highlight all lines having word under cursor (whole word match)
inoremap <silent> <C-s><C-l> <C-o>:call <SID>Highlight("l") \| nohls<CR>
" Highlight word under cursor (partial word match)
inoremap <silent> <C-s><C-f> <C-o>:call <SID>Highlight("f") \| nohls<CR>
" Highlight all lines having word under cursor (partial word match)
inoremap <silent> <C-s><C-k> <C-o>:call <SID>Highlight("k") \| nohls<CR>
" Highlight last search pattern
inoremap <silent> <C-s><C-s> <C-o>:call <SID>Highlight("s") \| nohls<CR>
" Highlight all lines having last search pattern
inoremap <silent> <C-s><C-j> <C-o>:call <SID>Highlight("j") \| nohls<CR>
" Clear last pattern highlight
inoremap <silent> <C-s><C-d> <C-o>:call <SID>Highlight("d")<CR>

" Clear all highlights
inoremap <silent> <C-s><C-n> <C-o>:call <SID>Highlight("n")<CR>
